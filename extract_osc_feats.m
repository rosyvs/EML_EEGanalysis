...
sublist = [1:158];
% repro=1
% sublist=[ 111 115 129:140]
%%%%%%%%%
exclude = [1:18 20:24 26 27 31 39 40 78 77 88 138 121 129 160 166]; % Subj to exclude because no eeg or no trigger etc. 54 i fixable - check message file 6. 121,166 not unique?? 
...
if repro==1
    for s = 1:length(sublist)
        ...
        trl(:,2) = trl(:,1)+logtrig.duration_sec*1000;
